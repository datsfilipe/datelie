...
function LinkButton({ href, onClick, icon, label, sublabel, variant = "outline" }: LinkButtonProps) {
  ...
  return (
    <Tag
      ...
      onMouseEnter={(e) => {
        ...
        if (variant === "primary") {
          ...
          el.style.boxShadow = "0 6px 32px rgba(255,13,151,0.6), inset 0 1px 0 rgba(255,255,255,0.08)";
      ...
      onMouseLeave={(e) => {
        ...
        if (variant === "primary") {
          ...
          el.style.boxShadow = "0 4px 24px rgba(255,13,151,0.4), inset 0 1px 0 rgba(255,255,255,0.08)";
        } else if (variant === "outline") {
    ...
    >
      ...
      <span style={{ flex: 1 }}>
        <span style={{ display: "block", fontSize: "16px", fontWeight: 500 }}>
          {label}
        </span>
        {sublabel && (
          <span
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-4 pt-10 pb-6 min-h-screen">
        ...
        <header className="w-full max-w-md text-center mb-7 md:max-w-2xl lg:max-w-5xl">
          ...
          >
            Deuzinete Ateliê transforma a roupa dos seus sonhos em realidade.
            Cada peça é feita sob medida, são mais de{" "}
            <span style={{ color: "#ff0d97", fontWeight: 500 }}>
              15 anos de experiência
            </span>{" "}
            em modelagem e crepagem.
          </p>
          ...
          <div className="flex items-center justify-center gap-3 mt-5">
            <span
              style={{
                ...
                width: "40px",
                background:
                  "linear-gradient(to right, transparent, rgba(255,13,151,0.4))",
              }}
            />
            <span
              style={{ color: "#ff0d97", fontSize: "14px", opacity: 0.7 }}
            >
              ✦
            </span>
            <span
              style={{
                ...
                width: "40px",
                background:
                  "linear-gradient(to left, transparent, rgba(255,13,151,0.4))",
              }}
            />
          </div>
        </header>
